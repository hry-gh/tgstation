GAME_VERB_PROC(/client, makepAI, "Make pAI", "Specify a location to spawn a pAI device, then specify a key to play that pAI", "Admin.Fun")
	VERB_ARG(target, VERB_ARG_TYPE_TURF, VERB_ARG_SOURCE_WORLD)
