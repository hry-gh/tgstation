...
/datum/controller/subsystem/verb_manager/input/proc/setup_default_macro_sets()
	macro_set = list(
		...
		"Back" = "\".output browseroutput:update [TGUI_PANEL_CLEAR_MESSAGE]\\n.winset \\\"input.text=\\\"\\\"\\\"\"",
		"Tab" = "\".output browseroutput:update [TGUI_PANEL_FOCUS_MESSAGE]\\n.winset \\\"browseroutput.focus=true?map.focus=true:browseroutput.focus=true\\\"\"",
