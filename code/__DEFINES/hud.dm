...
#define HUD_DISPLACEMENT_TYPE_GROUPS list( \
	/atom/movable/screen/ghost = list(HUD_MOB_LANGUAGE_MENU, HUD_MOB_FLOOR_CHANGER), \
	/atom/movable/screen/lobby = null)
